...
export default function Gratuidade({
  ...
  const isConforme =
    equivalenteOfertado >= exigido && integrais >= minimoIntegrais;
  const percentual =
    Math.min(100, Math.round((equivalenteOfertado / exigido) * 100)) || 0;
  ...
  const syncWithERP = () => {
    ...
    setBeneficios(8.4);
    if (onToast)
      onToast("Dados acadêmicos e financeiros sincronizados com o ERP.");
  };
    ...
    <div className="animate-in fade-in duration-300">
      ...
      <div className="bg-[#292e43] rounded-xl p-5 text-white flex flex-col md:flex-row md:items-center gap-6 justify-between shadow-md">
        <div className="flex md:items-center gap-6 flex-col md:flex-row">
          <div className="shrink-0">
            <span className="text-[9px] uppercase tracking-widest text-[#98a5b8] font-bold">
              Regra Aplicada
            </span>
            <h2 className="text-lg font-serif mt-1">
              1 bolsa integral / 5 pagantes
            </h2>
          </div>
          <div className="hidden md:block w-px h-10 bg-[#50566b]"></div>
          <p className="text-xs text-[#bfc5d2] max-w-2xl leading-relaxed">
            Admite composição com bolsas parciais de 50%, observado o mínimo de
            1 bolsa integral para cada 9 pagantes e o limite de substituição por
            benefícios.
          </p>
        </div>
        <a
          href="https://www.planalto.gov.br/ccivil_03/leis/lcp/lcp187.htm"
          target="_blank"
          rel="noreferrer"
          className="text-[11px] font-bold text-[#c49a3c] hover:text-[#e8dcc8] transition-colors flex items-center gap-1 shrink-0"
        >
      ...
      <div className="grid lg:grid-cols-[2fr_1fr] gap-6 mt-6">
        <Card className="p-6 md:p-8">
          <div className="flex justify-between items-start mb-6">
            <div>
              ...
              <h3 className="font-serif text-xl text-[#34332f] mt-1">
                Simulador de conformidade
              </h3>
            </div>
            <button
              onClick={syncWithERP}
              className="text-[#879087] hover:text-[#34332f] bg-[#f4f5fb] px-3 py-1.5 rounded text-[10px] font-bold flex items-center gap-2 border border-[#e8e1d6] transition-colors"
            >
          ...
          <div className="grid md:grid-cols-2 gap-x-6 gap-y-5">
            <div className="md:col-span-2">
              <label className="block text-[11px] font-bold text-[#879087] mb-1.5 uppercase tracking-wider">
                Alunos pagantes
              </label>
              <input
                type="number"
            ...
            <div className="md:col-span-2">
              <label className="block text-[11px] font-bold text-[#879087] mb-1.5 uppercase tracking-wider">
                Benefícios convertidos em bolsas
              </label>
              <input
                type="number"
                value={beneficios || ""}
          ...
          <div className="mt-6 bg-[#fcfbfa] border-l-4 border-[#c49a3c] p-4 rounded-r-lg flex gap-3 text-[#647078] text-xs leading-relaxed">
            ...
            <p>
              A simulação usa equivalência de 2 bolsas parciais para 1 integral.
              No produto final, os dados serão importados automaticamente do
              sistema acadêmico e da contabilidade via API.
            </p>
          </div>
        </Card>
        ...
        <Card className="p-6 md:p-8 flex flex-col items-center justify-center text-center relative overflow-hidden">
          <span
            className={`absolute top-6 right-6 text-[9px] font-bold uppercase tracking-widest px-2 py-1 rounded border ${isConforme ? "bg-[#e7f3ee] text-[#4b8c78] border-[#bce0d3]" : "bg-[#fdf0f0] text-[#d94444] border-[#f5c2c2]"}`}
          >
          ...
          <div className="relative h-40 w-40 mt-6 mb-6">
            ...
            >
              ...
              <circle
                ...
                r="45"
                fill="none"
                stroke={isConforme ? "#c49a3c" : "#d94444"}
                strokeWidth="6"
                strokeDasharray="283"
                strokeDashoffset={283 - (283 * percentual) / 100}
                strokeLinecap="round"
          ...
          <div className="w-full space-y-3 text-xs border-t border-[#e8e1d6] pt-5">
            ...
            <div className="flex justify-between items-center bg-[#f4f2ea] px-3 py-2 rounded">
              ...
              <strong
                className={isConforme ? "text-[#4b8c78]" : "text-[#d94444]"}
              >
                {equivalenteOfertado.toFixed(1)}
              </strong>
            </div>
            <div className="flex justify-between items-center bg-[#f4f2ea] px-3 py-2 rounded">
              <span className="text-[#647078]">Mínimo de integrais</span>
              <strong className="text-[#34332f]">
                {minimoIntegrais.toFixed(1)}
              </strong>
            </div>
          </div>
        </Card>
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-6">
        <Card className="p-6">
          ...
          <h4 className="font-serif text-lg text-[#34332f] mt-1 mb-2">
            Regra 1 / 5
          </h4>
          <p className="text-[11px] text-[#879087] leading-relaxed">
            Ponderações especiais para bolsa integral de aluno com deficiência
            (1,2) ou em tempo integral (1,4), sem acumulação.
          </p>
        </Card>
        ...
        <Card className="p-6">
          ...
          <p className="text-[11px] text-[#879087] leading-relaxed">
            Exige ainda oferta em todos os cursos e ao menos 1 bolsa integral
            para cada 25 pagantes em cada IES.
          </p>
        </Card>
        ...
        <Card className="p-6">
          ...
          <h4 className="font-serif text-lg text-[#34332f] mt-1 mb-2">
            1,5 ou 3 salários mínimos
          </h4>
          <p className="text-[11px] text-[#879087] leading-relaxed">
            Renda familiar per capita para bolsa integral e parcial de 50%,
            respectivamente, validada por assistente social.
          </p>
        </Card>
      </div>
    </div>
